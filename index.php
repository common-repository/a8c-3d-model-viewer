<?php
/**
 * Plugin Name: A8C 3D Model Viewer
 * Description: Show 3D models in an interactive viewer. Add files in .gltf or .glb formats.
 * Version:     1.0.0
 * Author:      Automattic
...
include_once __DIR__ . '/blocks/model-viewer.php';
